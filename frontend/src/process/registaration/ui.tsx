...
export const Registration = () => {
  ...
  const handleValidField = (
    type: "email" | "password" | "name" | "serdName",
    value: string
  ) => {
        ...
        <div className="registration__formContainer">
            ...
            <div className="auth__loginForm">
              ...
              >
                <FormControl
                  ...
                  variant="filled"
                  error={
                    !validateField.name.isValid &&
                    validateField.name.isValid !== null
                      ? true
                      : false
                  }
                >
                  ...
                  <DarkFilled
                    ...
                    onChange={(event) =>
                      setAuthField({ ...authField, name: event.target.value })
                    }
                    required
                    id="name"
                    type="text"
                    onBlur={(event) =>
                      handleValidField("name", event.target.value)
                    }
                  />
                ...
                <FormControl
                  ...
                  variant="filled"
                  error={
                    !validateField.serdName.isValid &&
                    validateField.serdName.isValid !== null
                      ? true
                      : false
                  }
                >
                  ...
                  <DarkFilled
                    ...
                    id="serdName"
                    onBlur={(event) =>
                      handleValidField("serdName", event.target.value)
                    }
                  />
              ...
              <Box mt={2} mb={2}>
                <FormControl
                  ...
                  error={
                    ...
                    validateField.email.isValid !== null
                      ? true
                      : false
                  }
                >
                  ...
                  <DarkFilled
                    ...
                    onChange={(event) =>
                      setAuthField({ ...authField, email: event.target.value })
                    }
                    required
                    type="email"
                    id="email"
                    onBlur={(event) =>
                      handleValidField("email", event.target.value)
                    }
                  />
              ...
              <Box mt={2} mb={2}>
                <FormControl
                  ...
                  error={
                    ...
                    validateField.password.isValid !== null
                      ? true
                      : false
                  }
                  variant="filled"
          ...
          <div className="auth__noAccount">
            ...
            <div className="auth__noAccount-info">
              <p className="auth__noAccount-txt">
